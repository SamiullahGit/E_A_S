...
function showInactivityWarning() {
    ...
    messageDiv.textContent = 'You have been inactive for 13 minutes. Your session will expire in 2 minutes.';
...
function resetInactivityTimer() {
    ...
    warningTimer = setTimeout(() => {
        console.log('[WARNING] User has been inactive for 13 minutes');
...
console.log('[INIT] Inactivity timeout handler initialized - 15 minute timeout');
